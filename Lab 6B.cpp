...
The statistics (high, low, average) are only for valid numbers; don't include any of the invalid numbers.
Open your input file in main, but read data inside the Calculate_Stat() function. */
#include <iostream>
#include <iomanip>
#include <fstream>
using namespace std;
